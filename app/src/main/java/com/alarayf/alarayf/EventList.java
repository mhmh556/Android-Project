...
import com.alarayf.alarayf.ServiceAPI.HttpManager;
...
public class EventList extends AppCompatActivity {
    ...
    private List<Event_list_data> data_response;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.alarayf.alarayf.R.layout.activity_event_list);
        ...
        mFirebaseAnalytics.logEvent("Event_Screen", null);
        ...
        getSupportActionBar().setTitle("الناسبات");
        //***********
       ...
       // mytextView.setTypeface(mytypeface);
        ...
        // when item get selected navigate to detial view
            ...
            mylist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(EventList.this, Event_datil.class);
        ...
        RelativeLayout RL = (RelativeLayout)findViewById(com.alarayf.alarayf.R.id.content_event_list);
   ...
   ///########################################################################
    ...
    protected void updateDisplay() {
       Event_Adapter adapter = new Event_Adapter(this, com.alarayf.alarayf.R.layout.row_event_list, this.data_response);
...
private void getEventListFromAPI(){
    if(this.isOnline()) {
    showpDialog();
    ...
    EventDataAPI data1 = retrofit.create(EventDataAPI.class);

    Call<List<Event_list_data>> call = data1.getEventListFromAPI();

    call.enqueue(new Callback<List<Event_list_data>>() {
        @Override
        public void onResponse(Call<List<Event_list_data>> call, Response<List<Event_list_data>> response) {
            // create var
            String d1="";
        ...
        @Override
        public void onFailure(Call<List<Event_list_data>> call, Throwable t) {
            hidepDialog();
        }
    });
    } else {
