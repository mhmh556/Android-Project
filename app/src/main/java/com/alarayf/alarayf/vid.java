...
import com.alarayf.alarayf.Adapter.Vid_Adapter;

import com.alarayf.alarayf.ServiceAPI.VidDataAPI;
...
public class vid extends AppCompatActivity {
    ...
    private List<Vid_list_data> data_response;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseAnalytics.logEvent("Videos_Screen", null);

        //*************** Layout ***********************

        setContentView(com.alarayf.alarayf.R.layout.activity_vid);


// set the background image
        RelativeLayout RL = (RelativeLayout)findViewById(com.alarayf.alarayf.R.id.content_vid);
        ...
        getSupportActionBar().setTitle("فيديو");
        //*************** floating button ***********************
...
*/
    ...
    protected void updateDisplay() {
        Vid_Adapter adapter = new Vid_Adapter(this, com.alarayf.alarayf.R.layout.row_vid, this.data_response);
    ...
    private void getVidListFromAPI(){
    ...
    private void get_Data() {
        ...
        VidDataAPI data1 = retrofit.create(VidDataAPI.class);

        Call<List<Vid_list_data>> call = data1.getVidListFromAPI();

        call.enqueue(new Callback<List<Vid_list_data>>() {
            @Override
            public void onResponse(Call<List<Vid_list_data>> call, Response<List<Vid_list_data>> response) {
                // create var
                String d1="";
       ...
       /*
        ...
        Log.d("tttttt",d1);*/
            ...
            @Override
            public void onFailure(Call<List<Vid_list_data>> call, Throwable t) {
                hidepDialog();
                //Toast.makeText(this, "فشل في الاتصال بالانترنت", Toast.LENGTH_LONG).show();
            }
        });
